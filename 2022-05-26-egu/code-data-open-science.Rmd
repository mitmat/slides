...
Example, soft (not strict) guideline

```{r eval=F}
# (optional) Summary description of script
...
(borrowed from https://speakerdeck.com/jennybc/how-to-name-files)
...
<img src="fig/autocomplete.png" height="400">
